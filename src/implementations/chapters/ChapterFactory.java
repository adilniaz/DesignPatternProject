    ...
    public Chapter createChapter (Chapters chapitres) {
        ...
        switch (chapitres) {
            ...
            case sword_of_seal :
            	...
            	CharacterAbstract ashnard = factoryPersonnage.createCharacter("Ashnard", orga, FireEmblemCharacterType.king_daein);
                ((Character)ashnard).setPosition(new Position(0, 10));
                ((Character)ashnard).ajouterObjet(factoryObjet.createObjet("Alondite", ObjetType.alondite));
                CharacterAbstract chevalier_noir = factoryPersonnage.createCharacter("Chevalier noir", orga, FireEmblemCharacterType.chevalier_noir);
                ((Character)chevalier_noir).setPosition(new Position(2, 10));
                ((Character)chevalier_noir).ajouterObjet(factoryObjet.createObjet("Alondite", ObjetType.alondite));

                ((GamePlatform)plateauDeJeu1).ajouterEnnemie(chevalier_noir);
